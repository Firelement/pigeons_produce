...
import net.minecraft.world.World;
    ...
    public class ModKnifeReturnable extends TieredItem{
        private final float attackDamage;
        private final float attackSpeed;

        public ModKnifeReturnable(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
            super(tier, builder);
